...
let StatsService = class StatsService {
    ...
    async summary(userId) {
        ...
        const bestTrade = trades.reduce((best, t) => (best == null || t.pnl > best.pnl ? t : best), null);
        const worstTrade = trades.reduce((worst, t) => (worst == null || t.pnl < worst.pnl ? t : worst), null);
        let maxWinStreak = 0;
        let maxLossStreak = 0;
        let curWin = 0;
        let curLoss = 0;
